...
function Projects() {
    return (
        <div className="projectContainer">
            <div className="card" style={{width: "23rem", border: "10px solid #05386B"}}>
                ...
                <a href="https://github.com/carlincb/Marvelisms" target="_blank" rel="noreferrer" className="btn btn-primary">Github Repository</a>
                </div>
            </div>
            <div className="card" style={{width: "23rem", border: "10px solid #05386B"}}>
                ...
                <a href="https://github.com/gallaghj13/Weather-Dashboard" target="_blank" rel="noreferrer" className="btn btn-primary">Github Repository</a>
                </div>
            </div>
            <div className="card" style={{width: "23rem", border: "10px solid #05386B"}}>
                ...
                <a href="https://github.com/gallaghj13/Daily-Planner-App" target="_blank" rel="noreferrer" className="btn btn-primary">Github Repository</a>
                </div>
            </div>
            <div className="card" style={{width: "23rem", border: "10px solid #05386B"}}>
                ...
                <a href="https://github.com/ParagasR/Gamers-Connect" target="_blank" rel="noreferrer" className="btn btn-primary">Github Repository</a>
                </div>
            </div>
            <div className="card" style={{width: "23rem", border: "10px solid #05386B"}}>
                ...
                <a href="https://github.com/gallaghj13/Employee-Tracker" target="_blank" rel="noreferrer" className="btn btn-primary">Github Repository</a>
                </div>
            </div>
            <div className="card" style={{width: "23rem", border: "10px solid #05386B"}}>
                ...
                <a href="https://github.com/gallaghj13/PWA-Text-Editor" target="_blank" rel="noreferrer" className="btn btn-primary">Github Repository</a>
                </div>
            </div>
        </div>
    );
